...
<section class="probootstrap_section">
	<div class="container">
		<div class="row text-center mb-5 probootstrap-animate fadeInUp probootstrap-animated">
			<div class="col-md-12">
				<h2 class="border-bottom probootstrap-section-heading">유실물 안내</h2>
			</div>
		</div>
		<form name="frmSch">
		...
		<div class="col-md">
						<div class="form-group">
							<div class="probootstrap-date-wrap">
								...
								<input type="text" id="sDate" value="<%=pi.getSdate() %>" name="sDate" class="form-control bg-white" readonly>
							</div>
						</div>
					</div>
					<div class="col-md">
						<div class="form-group">
							<div class="probootstrap-date-wrap">
								<span class="icon ion-calendar"></span>
								<input type="text" id="eDate" value="<%=pi.getEdate() %>" name="eDate" class="form-control bg-white" readonly>
							</div>
						</div>
					</div>
			<div class="col-md-2">
