	...
	<div class="d-flex align-items-center">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb m-0 p-0">
	            ...
	            <li class="breadcrumb-item text-muted active" aria-current="page">공지사항 글보기</li>
	        </ol>
		</nav>
	</div>
</div>
			...
			<input type="hidden" name="kind" value="${kind }" />	<!-- 등록/수정 -->
				<table class="table custom">
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                    	<th scope="row" class="text-center table-primary ">No</th>
	                    	<td class="text-center">${ni.getNl_idx() }</td>
	                    	...
	                    	<c:if test="${ni.getNl_isview() == 'Y'}" >게시</c:if><c:if test="${ni.getNl_isview() == 'N'}" >미게시</c:if></td>
	                    </tr>
	                    <tr>
