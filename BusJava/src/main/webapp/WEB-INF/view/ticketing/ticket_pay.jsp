...
int totalPee1 = ri1.getTotalPee(), totalPee2 = 0;
...
<section class="probootstrap_section">
	<div class="container">
		<div class="row text-center mb-5 probootstrap-animate fadeInUp probootstrap-animated">
			<div class="col-md-12"><h2 class="border-bottom probootstrap-section-heading"><%=ri1.getRi_line_type().equals("H") ? "고속" : "시외" %>버스 예매</h2></div>
			<div class="col-md-12">
			  ...
			  <table class="table">
			    ...
			    <tbody>
			      ...
			      <tr class="border-b">
			        ...
			        <td colspan="3" class="text-left">어른 <%=ri1.getRi_acnt() %>명, 청소년 <%=ri1.getRi_scnt() %>명, 아동 <%=ri1.getRi_ccnt() %>명</td>
			        <td>예매 좌석</td>
...
%>
				...
				<table class="table">
				  ...
				  <tbody>
				    ...
				    <tr class="border-b">
				      <td colspan="2">예매 매수</td>
				      <td colspan="3" class="text-left">어른 <%=ri2.getRi_acnt() %>명, 청소년 <%=ri2.getRi_scnt() %>명, 아동 <%=ri2.getRi_ccnt() %>명</td>
				      <td>예매 좌석</td>
...
<% } %>
			...
			<div class="col-md-12 mb-3">
		        ...
		        <div class="scroll-box">
					...
					제3조 (약관의 적용)<br />
					1) 이 약관은 회사에 의한 여객의 운송 또는 이에 부수되는 업무에 적용된다.<br />
					2) 이 약관이 관계법규에 저촉된 때에는 적용하지 아니한다.<br />
            ...
            <div class="d-flex justify-content-between">
              ...
              <div>
				<div class="d-flex align-items-center">
		           <p class="h6 mb-0 mr-3"><%=loginInfo.getMi_coupon() %>개</p>
     ...
     <div class="col-md-5 text-center mb-5 mt-5">
       ...
       <div class="form-check custom">
         <input class="form-check-input" type="radio" name="paymentOpt" id="payment5" value="쿠폰" disabled>
         <label class="form-check-label" for="payment5">쿠폰</label>
       </div>
     </div>
     <div id="pmoney_view">
       <div>
<% if (loginInfo.getMi_pmoney() > (totalPee1 + totalPee2)) { // 회원의 보유 페이머니가 결제금액보다 큰 경우 %>
...
function couponModal() {
	$('#CouponModal .modal-content').load("/busjavaf/pickCoupon");
...
const totalPee = <%=totalPee1 %> + <%=totalPee2 %>;
...
$("#totalPee").text(totalPee.toLocaleString("ko-KR"));
$("#realPrice").text(totalPee.toLocaleString("ko-KR"));
...
$("#paySubmitBtn").on('click', function() {
	...
	if (paymentOpt == "페이머니" && myPmoney < totalPee) {
...
$(document).on("click", "#PopBtnCoupon", function() {
	...
	if (selectedCoupon == null)	{
		...
		$("#realPrice").text((totalPee - discount).toLocaleString("ko-KR"));
