		...
		<div class="d-flex align-items-center">
		    <nav aria-label="breadcrumb">
		        <ol class="breadcrumb m-0 p-0">
		            ...
		            <li class="breadcrumb-item text-muted active" aria-current="page">유실물 상세</li>
		        </ol>
		    </nav>
		</div>
	</div>
			            ...
			            <table class="table">
			                ...
			                <tbody>
			                    ...
			                    <tr>
			                        ...
			                        <td class="text-left">
			                            <div class="d-flex"><c:if test="${li.getLl_status() == 'A' }" >보관중</c:if><c:if test="${li.getLl_status() == 'B' }" >수령완료</c:if></div>
			                        </td>
			                        <th scope="row" class="text-center table-primary align-middle">습득일자</th>
			                        <td class="text-left">
			                            <div class="d-flex">${li.getLl_date() } ${li.getLl_time() }</div>
			                        </td>
			                    </tr>
			                </tbody>
			            </table>
