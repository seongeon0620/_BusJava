...
public class BannerCtrl {
	...
	//public String bannerList (Model model, HttpServletRequest request) throws Exception {
	public ModelAndView bannerList (Model model, HttpServletRequest request) throws Exception {
		...
		pi.setRcnt(rcnt);		pi.setSpage(spage);		pi.setNum(num);			pi.setIsview(isview);
		pi.setKeyword(keyword);	pi.setArgs(args);		pi.setSchargs(schargs); 
	...
	public String bannerIn(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletRequest request, HttpServletResponse response) throws Exception {
	      ...
	      String uploadPath = "E:\\3차 Busjava\\admin_busjavaF\\src\\main\\webapp\\resources\\images\\banner";
	      String uploadPath2 = "E:\\3차 Busjava\\busjavaf\\src\\main\\webapp\\resources\\images\\banner";
	      String files = "";
	      String kind = request.getParameter("kind");
