...
public class BookInfo {
	private int ri_acnt, ri_scnt, ri_ccnt, rd_seat_num, ri_count, cr_coupon; 
	...
	public BookInfo(String ri_idx, String ri_line_type, String ri_fr, String ri_to, String ri_frdate, 
			String ri_status, String ri_frtime, int ri_acnt,int ri_scnt,int ri_ccnt, List<BusSeatList> busSeatList) {
		super();
		this.ri_idx = ri_idx;
	...
	public BookInfo(int ri_acnt, int ri_scnt, int ri_ccnt, String ri_status, String ri_idx, String ri_line_type,
			...
			String ri_frtime, String ri_totime, String pd_payment, String pd_date, int pd_real_price, int pd_total_price, List<BusSeatList> busSeatList) {
		super();
		this.ri_acnt = ri_acnt;
		this.ri_scnt = ri_scnt;
		this.ri_ccnt = ri_ccnt;
	...
	// 예매 취소 및 환불
	public BookInfo(String ri_frdate, int pd_real_price, int pd_total_price, String pd_payment , int mi_pmoney, int cr_pmoney, int cr_pay, int cr_coupon) {
		super();
		this.ri_frdate = ri_frdate;
		this.pd_real_price = pd_real_price;
		this.pd_total_price = pd_total_price;
